...
export const Route = createFileRoute('/users/$userId')({
  loader: async ({ context: { orpc, queryClient }, params: { userId } }) => {
    await queryClient.ensureQueryData(orpc.user.get.queryOptions({ input: { id: userId } }))
  },
...
function UserDetailComponent() {
  ...
  const user = useQuery(orpc.user.get.queryOptions({ input: { id: userId } }))
